/*a function named addarrays()that accepts two arrays that are the same size*/
...
/*modification of the function to return a pointer to the array containing the totals*/
#include <stdio.h>
